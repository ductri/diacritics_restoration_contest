...
from model_def.simple_but_huge_and_huge import SimpleButHugeAndHuge
...
class TestSeq2SeqAttnWithSrc(unittest.TestCase):
    ...
    def test_forward(self):
        ...
        model = SimpleButHugeAndHuge(src_vocab_size=src_vocab_size, tgt_vocab_size=5)
    ...
    def test_train(self):
        ...
        model = SimpleButHugeAndHuge(src_vocab_size=src_vocab_size, tgt_vocab_size=tgt_vocab_size)
        model.train()
