...
from model_def.seq2seq_feeding_attn_with_src.decoder import DecoderGreedyInfer, AttnRawDecoder
from model_def.seq2seq_feeding_attn_with_src.encoder import Encoder, FlattenHiddenLSTM
from utils import pytorch_utils

"""
Temporarily stop:
Logging: Seq2SeqFeedingAttn/2019-06-13T11:50:26

------------------ 	Evaluation	------------------
INFO:root:Number of batchs: 157
INFO:root:New best score: 0.8415755707713177
INFO:root:Saved model at /source/main/train/output//saved_models/Seq2SeqFeedingAttn/2019-06-13T11:50:26/80000.pt
INFO:root:Current best score: 0.8415755707713177 recorded at step 80000

Docker container: diacritics_19-06-13_13_50_13
"""


class Seq2SeqFeedingAttn(nn.Module):

    def __init__(self, src_vocab_size, tgt_vocab_size, start_idx, end_idx):
        super(Seq2SeqFeedingAttn, self).__init__()
        self.lr_rate = 1e-3
        self.max_length = 100
    ...
    def forward(self, word_input, *args):
        ...
        h_c = (h_n, c_n)
        output = self.greedy_infer(h_c, outputs)
        return output
