...
from model_def.seq2seq_huge_feeding_attn import Seq2SeqHugeFeedingAttn


class TestSeq2SeqHugeFeedingAttn(unittest.TestCase):
    ...
    def test_forward(self):
        ...
        model = Seq2SeqHugeFeedingAttn(src_vocab_size=src_vocab_size, tgt_vocab_size=5, start_idx=1, end_idx=2)
    ...
    def test_train(self):
        ...
        model = Seq2SeqHugeFeedingAttn(src_vocab_size=src_vocab_size, tgt_vocab_size=tgt_vocab_size, start_idx=5, end_idx=end_idx)
        model.train()
